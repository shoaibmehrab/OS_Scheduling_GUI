...
//System.out.println("ENTER no. of processes:");
	...
	String a=JOptionPane.showInputDialog("Enter no of process");
...
do{
	...
	//System.out.println("ENTER YOUR CHOICE");
		...
		String string=JOptionPane.showInputDialog("ENTER YOUR CHOICE");
        ch=Integer.parseInt(string);
	...
	switch(ch)
	{
		case 1:
			...
			for( i=0;i<n;i++)
			{
 			...
 			bt[i]=Integer.parseInt(JOptionPane.showInputDialog("ENTER burst time for each process: p"+(i+1)));
			}
			n1=n;
			int turn[]=new int[n];
			apw1=new int[n+1];
	...
	case 3:
				...
				pro[i][1]=Integer.parseInt(JOptionPane.showInputDialog("Burst Time for P"+i+" :"));
				total+=pro[i][1];
				//System.out.print("Arrival Time for P"+i+" :");
				pro[i][2]=Integer.parseInt(JOptionPane.showInputDialog("Arrival Time for P"+i+" :"));
				}
				for(int i=0;i<n;i++)
				wt1[i]=pro[i][2];
		...
		case 4:
					...
					int ts=Integer.parseInt("enter time quantum");
					int k=0;
					sq[k]=0;
					i=0;
					temp=ts;
		...
		case 5:
			...
			pr[i]=Integer.parseInt(JOptionPane.showInputDialog("Enter the priority for p"+(i+1)));
			}
		...
		case 6:
			...
			pro[i][0]=i;
			//System.out.print("Burst Time for P"+i+" :");
			pro[i][3]=Integer.parseInt(JOptionPane.showInputDialog("Burst Time for P"+i+" :"));
			total+=pro[i][3];
			//System.out.print("Arrival Time for P"+i+" :");
			pro[i][2]=Integer.parseInt(JOptionPane.showInputDialog("Arrival Time for P"+i+" :"));
			//System.out.print("Priority for P"+i+" :");
			pro[i][1]=Integer.parseInt(JOptionPane.showInputDialog("Priority for P"+i+" :"));
